...
object TestLibs : TestDependencyProvider, KaptTestDependencyProvider {
    ...
    private const val VERSION_ABP_TEST = "1.3.1"
    private const val VERSION_MOCKITO = "4.3.1"
    private const val VERSION_ROBOLECTRIC = "4.8.2"
    private const val VERSION_TEST_CORE = "1.1.1"
    private const val VERSION_TEST_COROUTINES = "1.6.0"
    private const val VERSION_TEST_DAGGER_HILT = "2.39"
    ...
    override fun testDependencies() = listOf(
        ...
        Dependency("org.robolectric", "robolectric", VERSION_ROBOLECTRIC),
